...
struct CAPI : public ::testing::Test
{
	void SetUp()
	{
		
        // With Python Interpreter TODO break out this logic
		PyConfig config;
...
TEST_F( CAPI, NameOfTest2 )
{
	EXPECT_TRUE( true );
}

TEST_F( CAPI, NameOfTest3 )
{
	EXPECT_TRUE( true );
}